...
CREATE TABLE `characters` (
  ...
  `health` decimal(39,0) unsigned NOT NULL DEFAULT '0',
  `power1` decimal(39,0) unsigned NOT NULL DEFAULT '0',
  `power2` decimal(39,0) unsigned NOT NULL DEFAULT '0',
  `power3` decimal(39,0) unsigned NOT NULL DEFAULT '0',
  `power4` decimal(39,0) unsigned NOT NULL DEFAULT '0',
  `power5` decimal(39,0) unsigned NOT NULL DEFAULT '0',
  `power6` decimal(39,0) unsigned NOT NULL DEFAULT '0',
  `power7` decimal(39,0) unsigned NOT NULL DEFAULT '0',
