...
CREATE TABLE IF NOT EXISTS `_武魂系统_模板` (
  ...
  `激活魂力消耗` int UNSIGNED NOT NULL DEFAULT 1000 COMMENT '激活武魂分身所需魂力',
  `进化魂力消耗` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '进化到该模板所需魂力，模板1为0',
  `副本Boss魂力` int UNSIGNED NOT NULL DEFAULT 1,
  `世界Boss魂力` int UNSIGNED NOT NULL DEFAULT 1,
