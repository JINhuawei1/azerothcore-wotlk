...
CREATE TABLE IF NOT EXISTS `_武魂系统_技能` (
  ...
  `学习消耗` decimal(65,0) UNSIGNED NOT NULL DEFAULT 100,
  `升级消耗` decimal(65,0) UNSIGNED NOT NULL DEFAULT 100,
...
ALTER TABLE `_武魂系统_技能`
  MODIFY COLUMN `学习消耗` decimal(65,0) UNSIGNED NOT NULL DEFAULT 100,
  MODIFY COLUMN `升级消耗` decimal(65,0) UNSIGNED NOT NULL DEFAULT 100;
