...
SELECT
  ...
  0, 100, 0, 100,
  0, CASE WHEN t.`is_boss` = 1 THEN 1800 + (t.`entry` - 800000) * 350 ELSE 450 END,
  0, 100,
  0, CASE WHEN t.`is_boss` = 1 THEN 300 ELSE 160 END,
  0, CASE WHEN t.`is_boss` = 1 THEN 260 ELSE 140 END,
  CASE WHEN t.`is_boss` = 1 THEN 70000 + (t.`entry` - 800001) * 20000 ELSE 22000 END,
  CASE WHEN t.`is_boss` = 1 THEN 120000 + (t.`entry` - 800001) * 30000 ELSE 42000 END,
  100,
  0, 0, 100,
  0, 0, 100,
  0, 0, 100,
  CASE WHEN t.`is_boss` = 1 THEN 30000 + (t.`entry` - 800001) * 8000 ELSE 10000 END,
  CASE WHEN t.`is_boss` = 1 THEN 45 ELSE 70 END,
  CASE WHEN t.`is_boss` = 1 THEN 45 ELSE 70 END,
  0,
  0, 0, 0, 0, 0, 0,
  ...
  CASE WHEN t.`is_boss` = 1 THEN CAST(60 + (t.`entry` - 800001) * 20 AS CHAR) ELSE '8' END,
  CASE WHEN t.`is_boss` = 1 THEN '古达克仙门试炼首领，掉落1万属性装备。' ELSE '古达克仙门试炼守卫。' END
FROM `_tmp_mirage_gundrak_template` t;

INSERT INTO `creature_loot_template`
  (`Entry`, `Item`, `Reference`, `Chance`, `QuestRequired`, `LootMode`, `GroupId`, `MinCount`, `MaxCount`, `Comment`)
VALUES
(800001, 95100, 0, 5, 0, 1, 0, 1, 1, '古达克仙门试炼Boss1随机仙器'),
(800001, 95101, 0, 5, 0, 1, 0, 1, 1, '古达克仙门试炼Boss1随机仙器'),
(800001, 95102, 0, 5, 0, 1, 0, 1, 1, '古达克仙门试炼Boss1随机仙器'),
(800001, 95103, 0, 5, 0, 1, 0, 1, 1, '古达克仙门试炼Boss1随机仙器'),
(800001, 95104, 0, 5, 0, 1, 0, 1, 1, '古达克仙门试炼Boss1随机仙器'),
(800002, 95105, 0, 5, 0, 1, 0, 1, 1, '古达克仙门试炼Boss2随机仙器'),
(800002, 95106, 0, 5, 0, 1, 0, 1, 1, '古达克仙门试炼Boss2随机仙器'),
(800002, 95107, 0, 5, 0, 1, 0, 1, 1, '古达克仙门试炼Boss2随机仙器'),
(800002, 95108, 0, 5, 0, 1, 0, 1, 1, '古达克仙门试炼Boss2随机仙器'),
(800002, 95109, 0, 5, 0, 1, 0, 1, 1, '古达克仙门试炼Boss2随机仙器'),
(800003, 95200, 0, 5, 0, 1, 0, 1, 1, '古达克仙门试炼Boss3随机仙装'),
(800003, 95201, 0, 5, 0, 1, 0, 1, 1, '古达克仙门试炼Boss3随机仙装'),
(800003, 95202, 0, 5, 0, 1, 0, 1, 1, '古达克仙门试炼Boss3随机仙装'),
(800003, 95203, 0, 5, 0, 1, 0, 1, 1, '古达克仙门试炼Boss3随机仙装'),
(800003, 95204, 0, 5, 0, 1, 0, 1, 1, '古达克仙门试炼Boss3随机仙装'),
(800003, 95205, 0, 5, 0, 1, 0, 1, 1, '古达克仙门试炼Boss3随机仙装'),
(800003, 95206, 0, 5, 0, 1, 0, 1, 1, '古达克仙门试炼Boss3随机仙装'),
(800003, 95207, 0, 5, 0, 1, 0, 1, 1, '古达克仙门试炼Boss3随机仙装'),
(800004, 95208, 0, 5, 0, 1, 0, 1, 1, '古达克仙门试炼Boss4随机仙饰'),
(800004, 95209, 0, 5, 0, 1, 0, 1, 1, '古达克仙门试炼Boss4随机仙饰'),
(800004, 95210, 0, 5, 0, 1, 0, 1, 1, '古达克仙门试炼Boss4随机仙饰'),
(800004, 95211, 0, 5, 0, 1, 0, 1, 1, '古达克仙门试炼Boss4随机仙饰'),
(800004, 95212, 0, 5, 0, 1, 0, 1, 1, '古达克仙门试炼Boss4随机仙饰'),
(800005, 95213, 0, 5, 0, 1, 0, 1, 1, '古达克仙门试炼Boss5随机仙兵/散件'),
(800005, 95214, 0, 5, 0, 1, 0, 1, 1, '古达克仙门试炼Boss5随机仙兵/散件'),
(800005, 95215, 0, 5, 0, 1, 0, 1, 1, '古达克仙门试炼Boss5随机仙兵/散件'),
(800005, 95216, 0, 5, 0, 1, 0, 1, 1, '古达克仙门试炼Boss5随机仙兵/散件'),
(800005, 95217, 0, 5, 0, 1, 0, 1, 1, '古达克仙门试炼Boss5随机仙兵/散件'),
(800005, 95218, 0, 5, 0, 1, 0, 1, 1, '古达克仙门试炼Boss5随机仙兵/散件'),
(800011, 95100, 0, 2, 0, 1, 0, 1, 1, '古达克仙门试炼小怪低概率1万仙器'),
(800012, 95101, 0, 2, 0, 1, 0, 1, 1, '古达克仙门试炼小怪低概率1万仙器'),
(800013, 95200, 0, 2, 0, 1, 0, 1, 1, '古达克仙门试炼小怪低概率1万仙装'),
(800014, 95205, 0, 2, 0, 1, 0, 1, 1, '古达克仙门试炼小怪低概率1万仙装'),
(800015, 95210, 0, 2, 0, 1, 0, 1, 1, '古达克仙门试炼小怪低概率1万仙饰'),
(800016, 95211, 0, 2, 0, 1, 0, 1, 1, '古达克仙门试炼小怪低概率1万仙饰'),
(800017, 95212, 0, 2, 0, 1, 0, 1, 1, '古达克仙门试炼小怪低概率1万仙饰'),
(800018, 95217, 0, 2, 0, 1, 0, 1, 1, '古达克仙门试炼小怪低概率1万披风');
