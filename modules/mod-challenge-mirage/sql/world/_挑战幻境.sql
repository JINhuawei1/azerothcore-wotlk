...
ALTER TABLE `_属性调整_生物`
  MODIFY COLUMN `物理攻击最小值` BIGINT UNSIGNED NOT NULL DEFAULT 0,
  MODIFY COLUMN `物理攻击最大值` BIGINT UNSIGNED NOT NULL DEFAULT 0,
  MODIFY COLUMN `真实伤害值` BIGINT UNSIGNED NOT NULL DEFAULT 0;
