...
CREATE TABLE `_物品鉴定_模板`  (
  ...
  `成长属性最小属性值` decimal(39,0) UNSIGNED NOT NULL DEFAULT 0 COMMENT '成长属性单条最小属性值',
  `成长属性最大属性值` decimal(39,0) UNSIGNED NOT NULL DEFAULT 0 COMMENT '成长属性单条最大属性值',
  ...
  `强化属性最小属性值` decimal(39,0) UNSIGNED NOT NULL DEFAULT 0 COMMENT '强化属性单条最小属性值',
  `强化属性最大属性值` decimal(39,0) UNSIGNED NOT NULL DEFAULT 0 COMMENT '强化属性单条最大属性值',
  ...
  `基础最小属性值` decimal(39,0) UNSIGNED NOT NULL DEFAULT 0,
  `基础最大属性值` decimal(39,0) UNSIGNED NOT NULL DEFAULT 0,
  ...
  `追加属性最小值` decimal(39,0) UNSIGNED NOT NULL DEFAULT 0,
  `追加属性最大值` decimal(39,0) UNSIGNED NOT NULL DEFAULT 0,
...
ALTER TABLE `_物品鉴定_模板`
  MODIFY COLUMN `成长属性最小属性值` decimal(39,0) UNSIGNED NOT NULL DEFAULT 0 COMMENT '成长属性单条最小属性值',
  MODIFY COLUMN `成长属性最大属性值` decimal(39,0) UNSIGNED NOT NULL DEFAULT 0 COMMENT '成长属性单条最大属性值',
  MODIFY COLUMN `强化属性最小属性值` decimal(39,0) UNSIGNED NOT NULL DEFAULT 0 COMMENT '强化属性单条最小属性值',
  MODIFY COLUMN `强化属性最大属性值` decimal(39,0) UNSIGNED NOT NULL DEFAULT 0 COMMENT '强化属性单条最大属性值',
  MODIFY COLUMN `基础最小属性值` decimal(39,0) UNSIGNED NOT NULL DEFAULT 0,
  MODIFY COLUMN `基础最大属性值` decimal(39,0) UNSIGNED NOT NULL DEFAULT 0,
  MODIFY COLUMN `追加属性最小值` decimal(39,0) UNSIGNED NOT NULL DEFAULT 0,
  MODIFY COLUMN `追加属性最大值` decimal(39,0) UNSIGNED NOT NULL DEFAULT 0;
