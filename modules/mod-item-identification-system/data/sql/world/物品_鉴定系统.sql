...
CREATE TABLE `物品_鉴定系统`  (
  ...
  `鉴定品质显示` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '品质显示文本',
  `物品名字前缀` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '物品名字前缀（字符串类型）',
  `物品名字后缀` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '物品名字后缀（字符串类型）',
  ...
  `物品底部描述` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '物品底部描述文本（字符串类型）',
