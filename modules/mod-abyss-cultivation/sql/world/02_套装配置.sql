...
CREATE TABLE `_深渊套装配置` (
  ...
  `2件全属性加成` decimal(65,0) unsigned NOT NULL DEFAULT 0 COMMENT '2件全属性加值',
  `2件暴击等级` decimal(65,0) unsigned NOT NULL DEFAULT 0 COMMENT '2件暴击等级加值',
  `2件急速等级` decimal(65,0) unsigned NOT NULL DEFAULT 0 COMMENT '2件急速等级加值',
  `2件攻击强度` decimal(65,0) unsigned NOT NULL DEFAULT 0 COMMENT '2件攻击强度加值',
  `2件法术强度` decimal(65,0) unsigned NOT NULL DEFAULT 0 COMMENT '2件法术强度加值',
  `4件效果描述` varchar(255) NOT NULL DEFAULT '' COMMENT '穿4件触发效果',
  `4件伤害加成百分比` decimal(65,0) unsigned NOT NULL DEFAULT 0 COMMENT '4件全伤害加成%',
  `4件生命值加成百分比` decimal(65,0) unsigned NOT NULL DEFAULT 0 COMMENT '4件最大生命值加成%',
  `4件额外暴击等级` decimal(65,0) unsigned NOT NULL DEFAULT 0 COMMENT '4件额外暴击等级',
  `4件额外急速等级` decimal(65,0) unsigned NOT NULL DEFAULT 0 COMMENT '4件额外急速等级',
  `4件特殊效果` varchar(128) NOT NULL DEFAULT '' COMMENT '4件特殊效果脚本标识',
  `6件效果描述` varchar(255) NOT NULL DEFAULT '' COMMENT '穿6件触发效果',
  `6件伤害加成百分比` decimal(65,0) unsigned NOT NULL DEFAULT 0 COMMENT '6件全伤害加成%',
  `6件生命值加成百分比` decimal(65,0) unsigned NOT NULL DEFAULT 0 COMMENT '6件最大生命值加成%',
  `6件额外暴击等级` decimal(65,0) unsigned NOT NULL DEFAULT 0 COMMENT '6件额外暴击等级',
  `6件额外急速等级` decimal(65,0) unsigned NOT NULL DEFAULT 0 COMMENT '6件额外急速等级',
  `6件特殊效果` varchar(128) NOT NULL DEFAULT '' COMMENT '6件特殊效果脚本标识',
  `8件效果描述` varchar(255) NOT NULL DEFAULT '' COMMENT '穿8件触发效果',
  `8件伤害加成百分比` decimal(65,0) unsigned NOT NULL DEFAULT 0 COMMENT '8件全伤害加成%',
  `8件生命值加成百分比` decimal(65,0) unsigned NOT NULL DEFAULT 0 COMMENT '8件最大生命值加成%',
  `8件额外暴击等级` decimal(65,0) unsigned NOT NULL DEFAULT 0 COMMENT '8件额外暴击等级',
  `8件额外急速等级` decimal(65,0) unsigned NOT NULL DEFAULT 0 COMMENT '8件额外急速等级',
...
ALTER TABLE `_深渊套装配置`
  MODIFY COLUMN `2件全属性加成` decimal(65,0) unsigned NOT NULL DEFAULT 0 COMMENT '2件全属性加值',
  MODIFY COLUMN `2件暴击等级` decimal(65,0) unsigned NOT NULL DEFAULT 0 COMMENT '2件暴击等级加值',
  MODIFY COLUMN `2件急速等级` decimal(65,0) unsigned NOT NULL DEFAULT 0 COMMENT '2件急速等级加值',
  MODIFY COLUMN `2件攻击强度` decimal(65,0) unsigned NOT NULL DEFAULT 0 COMMENT '2件攻击强度加值',
  MODIFY COLUMN `2件法术强度` decimal(65,0) unsigned NOT NULL DEFAULT 0 COMMENT '2件法术强度加值',
  MODIFY COLUMN `4件伤害加成百分比` decimal(65,0) unsigned NOT NULL DEFAULT 0 COMMENT '4件全伤害加成%',
  MODIFY COLUMN `4件生命值加成百分比` decimal(65,0) unsigned NOT NULL DEFAULT 0 COMMENT '4件最大生命值加成%',
  MODIFY COLUMN `4件额外暴击等级` decimal(65,0) unsigned NOT NULL DEFAULT 0 COMMENT '4件额外暴击等级',
  MODIFY COLUMN `4件额外急速等级` decimal(65,0) unsigned NOT NULL DEFAULT 0 COMMENT '4件额外急速等级',
  MODIFY COLUMN `6件伤害加成百分比` decimal(65,0) unsigned NOT NULL DEFAULT 0 COMMENT '6件全伤害加成%',
  MODIFY COLUMN `6件生命值加成百分比` decimal(65,0) unsigned NOT NULL DEFAULT 0 COMMENT '6件最大生命值加成%',
  MODIFY COLUMN `6件额外暴击等级` decimal(65,0) unsigned NOT NULL DEFAULT 0 COMMENT '6件额外暴击等级',
  MODIFY COLUMN `6件额外急速等级` decimal(65,0) unsigned NOT NULL DEFAULT 0 COMMENT '6件额外急速等级',
  MODIFY COLUMN `8件伤害加成百分比` decimal(65,0) unsigned NOT NULL DEFAULT 0 COMMENT '8件全伤害加成%',
  MODIFY COLUMN `8件生命值加成百分比` decimal(65,0) unsigned NOT NULL DEFAULT 0 COMMENT '8件最大生命值加成%',
  MODIFY COLUMN `8件额外暴击等级` decimal(65,0) unsigned NOT NULL DEFAULT 0 COMMENT '8件额外暴击等级',
  MODIFY COLUMN `8件额外急速等级` decimal(65,0) unsigned NOT NULL DEFAULT 0 COMMENT '8件额外急速等级';
