...
CREATE TABLE `_深渊套装配置` (
  ...
  `6件伤害加成百分比` tinyint unsigned NOT NULL DEFAULT 0 COMMENT '6件全伤害加成%',
  `6件生命值加成百分比` tinyint unsigned NOT NULL DEFAULT 0 COMMENT '6件最大生命值加成%',
  `6件额外暴击等级` smallint unsigned NOT NULL DEFAULT 0 COMMENT '6件额外暴击等级',
  `6件额外急速等级` smallint unsigned NOT NULL DEFAULT 0 COMMENT '6件额外急速等级',
  `6件特殊效果` varchar(128) NOT NULL DEFAULT '' COMMENT '6件特殊效果脚本标识',
  `8件效果描述` varchar(255) NOT NULL DEFAULT '' COMMENT '穿8件触发效果',
  `8件伤害加成百分比` tinyint unsigned NOT NULL DEFAULT 0 COMMENT '8件全伤害加成%',
  `8件生命值加成百分比` tinyint unsigned NOT NULL DEFAULT 0 COMMENT '8件最大生命值加成%',
  `8件额外暴击等级` smallint unsigned NOT NULL DEFAULT 0 COMMENT '8件额外暴击等级',
  `8件额外急速等级` smallint unsigned NOT NULL DEFAULT 0 COMMENT '8件额外急速等级',
