...
public:
    ...
    virtual void OnPlayerAfterUpdateSpellDamageAndHealing(Player* /*player*/, int256& /*healingBonus*/, int256 /*spellDamage*/[7]) { }
    // 评级属性钩子 - 用于修改命中、急速、精准等评级
    virtual void OnPlayerAfterUpdateRating(Player* /*player*/, CombatRating /*cr*/, int256& /*amount*/) { }
