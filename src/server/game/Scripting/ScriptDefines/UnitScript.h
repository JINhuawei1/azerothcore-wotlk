...
public:
    ...
    virtual void OnHeal(Unit* /*healer*/, Unit* /*reciever*/, uint256& /*gain*/) { }

    // Called when a unit deals damage to another unit
    virtual void OnDamage(Unit* /*attacker*/, Unit* /*victim*/, uint256& /*damage*/) { }

    // Called before legacy OnDamage handlers, with the core damage context preserved
    virtual void OnBeforeDamageWithContext(Unit* /*attacker*/, Unit* /*victim*/, uint256& /*damage*/, DamageEffectType /*damageType*/, SpellInfo const* /*spellInfo*/) { }

    // Called after legacy OnDamage handlers, with the final damage context preserved
    ...
    virtual void ModifyPeriodicDamageAurasTick(Unit* /*target*/, Unit* /*attacker*/, uint256& /*damage*/, SpellInfo const* /*spellInfo*/) { }

    // Called when Melee Damage is being Dealt
    virtual void ModifyMeleeDamage(Unit* /*target*/, Unit* /*attacker*/, uint256& /*damage*/) { }

    // Called when Spell Damage is being Dealt
    virtual void ModifySpellDamageTaken(Unit* /*target*/, Unit* /*attacker*/, uint256& /*damage*/, SpellInfo const* /*spellInfo*/) { }

    // Called when Heal is Recieved
    virtual void ModifyHealReceived(Unit* /*target*/, Unit* /*healer*/, uint256& /*heal*/, SpellInfo const* /*spellInfo*/) { }

    //Called when Damage is Dealt
    virtual uint256 DealDamage(Unit* /*AttackerUnit*/, Unit* /*pVictim*/, uint256 damage, DamageEffectType /*damagetype*/) { return damage; }
    ...
    virtual void OnAfterRollMeleeOutcomeAgainst(Unit const* /*attacker*/, Unit const* /*victim*/, WeaponAttackType /*attType*/, uint8 /*outcome*/) { }
