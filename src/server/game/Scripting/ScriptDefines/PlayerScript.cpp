...
void ScriptMgr::OnPlayerAfterUpdateSpellDamageAndHealing(Player* player, int128& healingBonus, int128 spellDamage[7])
{
...
void ScriptMgr::OnPlayerAfterUpdateRating(Player* player, CombatRating cr, int128& amount)
{
...
bool ScriptMgr::OnPlayerCanSeeCreature(Player const* player, Creature const* creature)
{
    CALL_ENABLED_BOOLEAN_HOOKS(PlayerScript, PLAYERHOOK_ON_CAN_SEE_CREATURE, !script->OnPlayerCanSeeCreature(player, creature));
}
