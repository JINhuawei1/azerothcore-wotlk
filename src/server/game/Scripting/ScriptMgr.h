...
public: /* PlayerScript */
    ...
    void OnPlayerAfterUpdateSpellDamageAndHealing(Player* player, int256& healingBonus, int256 spellDamage[7]);
    void OnPlayerAfterUpdateRating(Player* player, CombatRating cr, int256& amount);
    ...
    void OnPlayerApplyItemModsBefore(Player* player, uint8 slot, bool apply, uint8 itemProtoStatNumber, uint32 statType, int64& val);
...
public: /* UnitScript */
    ...
    void ModifyMeleeDamage(Unit* target, Unit* attacker, uint256& damage);
    void ModifySpellDamageTaken(Unit* target, Unit* attacker, uint256& damage, SpellInfo const* spellInfo);
    void ModifyHealReceived(Unit* target, Unit* healer, uint256& addHealth, SpellInfo const* spellInfo);
    uint256 DealDamage(Unit* AttackerUnit, Unit* pVictim, uint256 damage, DamageEffectType damagetype);
    ...
    void OnAfterRollMeleeOutcomeAgainst(Unit const* attacker, Unit const* victim, WeaponAttackType attType, uint8 outcome);
...
public: /* LootScript */
    ...
    void OnLootMoney(Player* player, uint64 gold);
